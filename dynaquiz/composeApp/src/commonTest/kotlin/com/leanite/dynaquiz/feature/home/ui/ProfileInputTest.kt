...
class ProfileInputTest : UiTest() {
    ...
    @Test
    fun `should render the nickname value in the input field`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
    ...
    @Test
    fun `should render the NOME placeholder when nickname is empty`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
    ...
    @Test
    fun `should call onNicknameChange with the typed value`() = runComposeUiTest {
    ...
    @Test
    fun `should render character count when nickname is shorter than minimum`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
    ...
    @Test
    fun `should render character count reflecting current length when valid`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                ProfileInput(nickname = "Leandro", onNicknameChange = {})
            }
