...
class DifficultyScreenTest : UiTest() {
    ...
    @Test
    fun `should render all four challenge mode options`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
    ...
    @Test
    fun `should render the description of each mode`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                DifficultyScreen(uiState = DifficultyUiState(), onIntent = {})
            }
    ...
    @Test
    fun `should pre-select the mode coming from uiState`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                DifficultyScreen(
    ...
    @Test
    fun `should emit ModeSelected when user taps a different mode option`() = runComposeUiTest {
    ...
    @Test
    fun `should emit ConfirmClicked when user taps the confirm button`() = runComposeUiTest {
        val captured = mutableListOf<DifficultyIntent>()
        setContent {
            DynaquizTheme {
                DifficultyScreen(
    ...
    @Test
    fun `should disable confirm button while isConfirming is true`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                DifficultyScreen(
