...
class ChallengeModeRepositoryImplTest {
    ...
    private val dataSource =
        object : ChallengeModeLocalDataSource {
    ...
    @Test
    fun `getMode should emit Timed Easy as default when nothing is stored`() =
        runTest {
    ...
    @Test
    fun `getMode should emit the mode corresponding to the stored serializedName`() =
        runTest {
    ...
    @Test
    fun `setMode should write the selected mode serializedName via the data source`() =
        runTest {
    ...
    @Test
    fun `setMode should make subsequent getMode emit the new value`() =
        runTest {
