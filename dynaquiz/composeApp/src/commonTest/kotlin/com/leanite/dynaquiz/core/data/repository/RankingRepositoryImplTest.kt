...
class RankingRepositoryImplTest {
    ...
    private fun createRepository() = RankingRepositoryImpl(
    ...
    private fun sessionResult() = QuizSessionResult(
        playerName = "Leandro",
    ...
    @Test
    fun `saveSession should ensure player via findOrInsert before inserting the session`() = runTest {
    ...
    @Test
    fun `saveSession should persist session fields using the playerId returned by findOrInsert`() = runTest {
        every { playerDataSource.findOrInsert(any(), any()) } returns
    ...
    @Test
    fun `saveSession should return Success Unit on happy path`() = runTest {
        every { playerDataSource.findOrInsert(any(), any()) } returns
    ...
    @Test
    fun `saveSession should return Error mapped from Throwable when findOrInsert throws`() = runTest {
    ...
    @Test
    fun `saveSession should return Error mapped from Throwable when insertSession throws`() = runTest {
        every { playerDataSource.findOrInsert(any(), any()) } returns
            SelectRankingFixtures.playerEntity()
        every {
    ...
    @Test
    fun `getTopRanking should map data source entries to domain RankingEntry list`() = runTest {
        every { quizSessionDataSource.selectRanking() } returns listOf(
    ...
    @Test
    fun `getTopRanking should return Success with empty list when there are no sessions`() = runTest {
    ...
    @Test
    fun `getTopRanking should return Error mapped from Throwable when data source throws`() = runTest {
    ...
    @Test
    fun `getTopRankingByPlayerName should forward player name to the data source`() = runTest {
    ...
    @Test
    fun `getTopRankingByPlayerName should map entries to domain RankingEntry list`() = runTest {
        every { quizSessionDataSource.selectRankingByPlayerName(any()) } returns listOf(
    ...
    @Test
    fun `getTopRankingByPlayerName should return Error mapped from Throwable when data source throws`() = runTest {
