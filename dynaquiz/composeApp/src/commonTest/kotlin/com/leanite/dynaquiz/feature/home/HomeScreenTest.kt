...
class HomeScreenTest : UiTest() {
    @Test
    fun `should render the nickname coming from uiState`() =
        runComposeUiTest {
            setContent {
                DynaquizTheme {
                    HomeScreen(
    ...
    @Test
    fun `should render the start difficulty and ranking buttons`() =
        runComposeUiTest {
            setContent {
                DynaquizTheme {
    ...
    @Test
    fun `should disable the start button when canStart is false`() =
        runComposeUiTest {
            setContent {
                DynaquizTheme {
    ...
    @Test
    fun `should disable the start button while isStarting is true`() =
        runComposeUiTest {
            setContent {
                DynaquizTheme {
                    HomeScreen(
    ...
    @Test
    fun `should emit NicknameChanged with trimmed uppercase value when user types`() =
        runComposeUiTest {
    ...
    @Test
    fun `should emit StartQuizClicked when user taps the start button`() =
        runComposeUiTest {
            val captured = mutableListOf<HomeIntent>()
            setContent {
                DynaquizTheme {
    ...
    @Test
    fun `should emit DifficultyClicked when user taps the difficulty button`() =
        runComposeUiTest {
            val captured = mutableListOf<HomeIntent>()
            setContent {
                DynaquizTheme {
    ...
    @Test
    fun `should emit RankingClicked when user taps the ranking button`() =
        runComposeUiTest {
            val captured = mutableListOf<HomeIntent>()
            setContent {
                DynaquizTheme {
    ...
    @Test
    fun `should render character counter reflecting the current nickname length`() =
        runComposeUiTest {
            setContent {
                DynaquizTheme {
                    HomeScreen(uiState = HomeUiState(nickname = "Leandro"), onIntent = {})
