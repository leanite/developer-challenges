...
class QuizScreenTest : UiTest() {
    ...
    @Test
    fun `should render the countdown number when phase is Countdown`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                QuizScreen(
                    uiState = QuizUiState(
    ...
    @Test
    fun `should render the question statement and options when phase is Playing`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
    ...
    @Test
    fun `should render the timer number when challengeMode is Timed and timeRemainingSec is set`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                QuizScreen(
    ...
    @Test
    fun `should not render the timer when challengeMode is Relaxed`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                QuizScreen(
                    uiState = playingState(
    ...
    @Test
    fun `should emit AnswerSelected with the tapped option text`() = runComposeUiTest {
    ...
    @Test
    fun `should disable all options once selectedAnswer is set`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                QuizScreen(
    ...
    @Test
    fun `should render the exit dialog when showExitDialog is true`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                QuizScreen(
    ...
    @Test
    fun `should not render the exit dialog when showExitDialog is false`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                QuizScreen(
    ...
    @Test
    fun `should emit ExitConfirmed when user taps the exit action in the dialog`() = runComposeUiTest {
        val captured = mutableListOf<QuizIntent>()
        setContent {
            DynaquizTheme {
                QuizScreen(
    ...
    @Test
    fun `should emit ExitCancelled when user taps the continue action in the dialog`() = runComposeUiTest {
        val captured = mutableListOf<QuizIntent>()
        setContent {
            DynaquizTheme {
                QuizScreen(
