...
class RankingTabBarTest : UiTest() {
    ...
    @Test
    fun `should render both All and Mine tab labels`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
    ...
    @Test
    fun `should mark All tab as selected when selectedTab is All`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
                RankingTabBar(selectedTab = RankingTab.All, onTabSelected = {})
            }
    ...
    @Test
    fun `should mark Mine tab as selected when selectedTab is Mine`() = runComposeUiTest {
        setContent {
            DynaquizTheme {
    ...
    @Test
    fun `should emit onTabSelected with All when user taps the All tab`() = runComposeUiTest {
    ...
    @Test
    fun `should emit onTabSelected with Mine when user taps the Mine tab`() = runComposeUiTest {
        val captured = mutableListOf<RankingTab>()
        setContent {
            DynaquizTheme {
